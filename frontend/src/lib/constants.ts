...
export const CHAIN_CONFIGS: Record<ChainKey, ChainConfig> = {
  ...
  "polygon-zkevm": evm("polygon-zkevm", "Polygon zkEVM", 1101, "ETH", "https://zkevm.polygonscan.com", "Ether"),
  fraxtal: evm("fraxtal", "Fraxtal", 252, "frxETH", "https://fraxscan.com", "Fraxtal Ether"),
  ...
  ink: evm("ink", "Ink", 57073, "ETH", "https://explorer.inkonchain.com", "Ether"),
  ...
  seda: nonEvm("seda", "Seda", "cosmos", "seda-1", "SEDA", 6, "https://www.mintscan.io/seda"),
